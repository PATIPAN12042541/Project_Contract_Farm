                  ...
                  <Form className="form-horizontal">
                      <div className="card-body">             
                          ...
                          <div className="form-group row">
                              ...
                              <div className="col-sm-8 col-form-label bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-focused bootstrap-switch-animate bootstrap-switch-on bootstrap-switch-container">
                                  ...
                                  <input
                                      type="checkbox"
                                      id="custom-switch"
                                      data-bootstrap-switch={updateChecked}
